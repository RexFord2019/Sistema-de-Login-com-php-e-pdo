<?php
 Class Usuario {
	...
	public $msgErro="";
  	...
  	{
		  //$pdo = $this->conectar("kpinater_dg","kpinaterrenos.com.br","kpinater_dg","false123*");
  		global $pdo;
      global $msgErro;
  		...
  		if($sql->rowCount()>0) //verificando houve resposta na consulta
  		{
  			...
  			$_SESSION['id'] = $dado["id_usuario"]; //armazena o id do usuario na sessao.
  			$_SESSION['nome'] = $dado["nome"]; //armazena o id do usuario na sessao.
